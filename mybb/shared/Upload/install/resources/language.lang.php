...
$l['mysql_check_successfully_step'] = '<p>MySQL is enabled</p>
<p><strong>Click "Next" to Requirements Check</strong></p>';

$l['mysql_check_failed_step'] = '<p>MySQL is not enabled</p>
<p><input type="checkbox" name="enable_db" value="TRUE" id="allow_dbenable" /> <label for="allow_dbenable"> Do you want to enable MySQL?</label></p>';
